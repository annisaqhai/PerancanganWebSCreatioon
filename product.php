...
<link href="css/dua.css" rel="stylesheet" type="text/css" media="all" />
<!-- font-awesome icons -->
	...
	<div class="agileits_header">
		<div class="container">
			<div class="w3l_offers">
				<p>DAPATKAN PENAWARAN MENARIK KHUSUS HARI INI,<a href=""> BELANJA SEKARANG! </a></p>
			</div>
	...
	<div class="logo_products">
		...
		<div class="w3ls_logo_products_left1">
				<ul class="phone_email">
					<li><i class="fa fa-phone" aria-hidden="true"></i>Hubungi Kami : 0852 8047 1050 </li>
				</ul>
			</div>
			<div class="w3ls_logo_products_left">
				<h1><a href="index.php">SCreatioon</a></h1>
			</div>
...
<div class="footer">
		<div class="container">
			<div class="w3_footer_grids">
				<div class="col-md-4 w3_footer_grid">
					...
					<ul class="address">
						<li><i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i>SCreatioon, Kota Padang</li>
						<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a href="mailto:screatioon@gmail.com">SCreatioon@gmail.com</a></li>
						<li><i class="glyphicon glyphicon-earphone" aria-hidden="true"></i>0852 8047 1050</li>
					</ul>
				</div>
		...
		<div class="footer-copy">
			...
			<div class="container">
				<p>© 2022 SCreatioon . All rights reserved</p>
			</div>
		</div>
